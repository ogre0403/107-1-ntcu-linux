...
![image](https://github.com/bill0330/107-1-ntcu-linux/blob/HW-3/ACS107137/img/1-1.1.PNG?raw=true)    
![image](https://github.com/bill0330/107-1-ntcu-linux/blob/HW-3/ACS107137/img/1-1.2.PNG?raw=true)    
# 1-2：    
## 請刪除系統中的 examuser3 這個帳號，同時將這個帳號的家目錄與郵件檔案同步刪除。    
用"userdel -r (username)"刪除使用者的家目錄及資料    
注意!!! 沒有加上-r家目錄不會刪除    
![image](https://github.com/bill0330/107-1-ntcu-linux/blob/HW-3/ACS107137/img/1-2.1.PNG?raw=true)    
![image](https://github.com/bill0330/107-1-ntcu-linux/blob/HW-3/ACS107137/img/1-2.2.PNG?raw=true)    
# 1-3：    
## examuser1 不小心被管理員刪除了，但是這個帳號的家目錄與相關郵件都還存在。請參考這個帳號可能的家目錄所保留的 UID 與 GID， 並嘗試以該帳號原有的 UID/GID 資訊來重建該帳號。    
用"useradd -u (原帳號的UID) (username)"重建帳號    
![image](https://github.com/bill0330/107-1-ntcu-linux/blob/HW-3/ACS107137/img/1-3.1.PNG?raw=true)    
![image](https://github.com/bill0330/107-1-ntcu-linux/blob/HW-3/ACS107137/img/1-3.2.PNG?raw=true)    
# 2-1：    
## 建立examuser4使用者帳號，密碼任意。    
登入使用者帳號後，用"su -"指令切換為管理者root    
用"useradd (username)"建立新帳號、"passwd (username)"設定密碼    
![image](https://github.com/bill0330/107-1-ntcu-linux/blob/HW-3/ACS107137/img/2-1.1.PNG?raw=true)    
# 2-2：    
...
![image](https://github.com/bill0330/107-1-ntcu-linux/blob/HW-3/ACS107137/img/2-2.1.PNG?raw=true)    
# 2-3：    
...
![image](https://github.com/bill0330/107-1-ntcu-linux/blob/HW-3/ACS107137/img/3-1.3.PNG?raw=true)    
