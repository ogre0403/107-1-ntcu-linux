...
* 因為examuser1是other 
 > vim /dev/shm/unit05/dir1/file1，無法用w:儲存，因為other沒有file1的修改權限
 > vim /dev/shm/unit05/dir2/file2，無法用w:儲存，因為other沒有file2的修改權限
 > vim /dev/shm/unit05/dir3/file3，可用w:儲存，因為other有file3的修改權限
 > vim /dev/shm/unit05/dir4/file4，無法用w:儲存，因為other沒有file4的修改權限
