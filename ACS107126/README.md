...
![3](3.mkdir.png)
   ...
   * 用法: grep [group] /etc/group
   (5) > 創建/srv/myproject這個目錄 (mkdir [創建目錄名])
...
####黃色框框利用ps aux呼叫出系統中的程序
####綠色的這個符號意思是使左邊的指令由右邊的指令繼續做下去
####藍色部分是對前面指令再進行篩選出rsyslog的相關程序
   * 用法: grep '要找的相關程序'
####紅色的部分是我要將上述結果"重新導向"到/root/process\_syslog.txt中
   * 用法: \> [file]
   *如果為新檔案, 則會自行創建*
